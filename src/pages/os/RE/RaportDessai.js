...
const RaportDessai = () => {
  ...
  useEffect(() => {
    ...
    const fetchFichesDessai = async () => {
      ...
      try {
        const response = await axios.get(`https://cetim-spring.onrender.com/api/fichedessai/${id}`, { // Use the id here
